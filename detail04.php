...
//２．データ登録SQL作成
$stmt = $pdo->prepare('SELECT * FROM gs_an_table03 WHERE id = :id;');
    ...
    <header>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand" href="read03.php">データ一覧</a></div>
            </div>
        </nav>
    </header>

    <!-- method, action, 各inputのnameを確認してください。  -->
    <form method="POST" action="insert04.php">
        <div class="jumbotron">
            <fieldset>
                <legend>本の詳細</legend>
